...
static void InitDefaultsscc_info_HealthCheckRequest_health_5fcheck_5fservice_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_HealthCheckRequest_health_5fcheck_5fservice_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_HealthCheckRequest_health_5fcheck_5fservice_2eproto}, {}};

static void InitDefaultsscc_info_HealthCheckResponse_health_5fcheck_5fservice_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_HealthCheckResponse_health_5fcheck_5fservice_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_HealthCheckResponse_health_5fcheck_5fservice_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_health_5fcheck_5fservice_2eproto[2];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_health_5fcheck_5fservice_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_health_5fcheck_5fservice_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_health_5fcheck_5fservice_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_health_5fcheck_5fservice_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\032health_check_service.proto\022\016grpc.healt"
  "h.v1\"%\n\022HealthCheckRequest\022\017\n\007service\030\001 "
  "\001(\t\"\251\001\n\023HealthCheckResponse\022A\n\006status\030\001 "
  "\001(\01621.grpc.health.v1.HealthCheckResponse"
  ".ServingStatus\"O\n\rServingStatus\022\013\n\007UNKNO"
  "WN\020\000\022\013\n\007SERVING\020\001\022\017\n\013NOT_SERVING\020\002\022\023\n\017SE"
  "RVICE_UNKNOWN\020\0032\256\001\n\006Health\022P\n\005Check\022\".gr"
  "pc.health.v1.HealthCheckRequest\032#.grpc.h"
  "ealth.v1.HealthCheckResponse\022R\n\005Watch\022\"."
  "grpc.health.v1.HealthCheckRequest\032#.grpc"
  ".health.v1.HealthCheckResponse0\001b\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_health_5fcheck_5fservice_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_health_5fcheck_5fservice_2eproto_sccs[2] = {
  &scc_info_HealthCheckRequest_health_5fcheck_5fservice_2eproto.base,
  &scc_info_HealthCheckResponse_health_5fcheck_5fservice_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_health_5fcheck_5fservice_2eproto_once;
static bool descriptor_table_health_5fcheck_5fservice_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_health_5fcheck_5fservice_2eproto = {
  &descriptor_table_health_5fcheck_5fservice_2eproto_initialized, descriptor_table_protodef_health_5fcheck_5fservice_2eproto, "health_check_service.proto", 440,
  &descriptor_table_health_5fcheck_5fservice_2eproto_once, descriptor_table_health_5fcheck_5fservice_2eproto_sccs, descriptor_table_health_5fcheck_5fservice_2eproto_deps, 2, 0,
  schemas, file_default_instances, TableStruct_health_5fcheck_5fservice_2eproto::offsets,
  file_level_metadata_health_5fcheck_5fservice_2eproto, 2, file_level_enum_descriptors_health_5fcheck_5fservice_2eproto, file_level_service_descriptors_health_5fcheck_5fservice_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_health_5fcheck_5fservice_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_health_5fcheck_5fservice_2eproto), true);
namespace grpc {
namespace health {
namespace v1 {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* HealthCheckResponse_ServingStatus_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_health_5fcheck_5fservice_2eproto);
  return file_level_enum_descriptors_health_5fcheck_5fservice_2eproto[0];
}
...
void HealthCheckRequest::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_HealthCheckRequest_health_5fcheck_5fservice_2eproto.base);
  service_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
const HealthCheckResponse& HealthCheckResponse::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_HealthCheckResponse_health_5fcheck_5fservice_2eproto.base);
  return *internal_default_instance();
}
